...
module FeldtRuby
  ...
  DefaultGoogleHitsCache = GoogleHitsCache.new
  ...
  def self.ngd(s1, s2)
    l_the =  Math.log2(DefaultGoogleHitsCache.num_hits("the"))
    l1 =  Math.log2(DefaultGoogleHitsCache.num_hits(s1))
    l2 =  Math.log2(DefaultGoogleHitsCache.num_hits(s2))
    l1and2 = Math.log2(DefaultGoogleHitsCache.num_hits(s1, s2))
